      ...
      {tab === 'documents' && (
        <div className="space-y-4">
          ...
          {docsLoading ? (
            ...
            <div className="bg-white dark:bg-neutral-900 rounded-2xl border border-gray-100 dark:border-neutral-700/80 shadow-sm overflow-hidden">
              {docs.map((doc, idx) => (
                <div key={doc.id} className={`flex items-center gap-4 px-5 py-4 ${idx !== docs.length - 1 ? 'border-b border-gray-50 dark:border-neutral-700/80' : ''}`}>
