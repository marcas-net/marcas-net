...
const orgTypes = [
  {
    ...
    sublabel: 'Manage certifications, connect with labs & regulators',
    connects: 'Works with Nutrition Labs and Regulators',
  ...
  },
  {
    ...
    sublabel: 'Share test results, connect with food companies',
    connects: 'Reports into Producers and Regulators',
  ...
  },
  {
    ...
    label: 'Universities',
    sublabel: 'Collaborate on research, publish findings',
    connects: 'Collaborates with Producers and Labs',
  ...
  },
  {
    ...
    sublabel: 'Oversight, inspections & compliance tracking',
    connects: 'Oversees Producers and reviews Lab outputs',
  ...
  },
  {
    ...
    sublabel: 'Build your profile, grow your network',
    connects: 'Supports all of the above',
          ...
          {orgTypes.map((org, i) => {
            ...
            return (
              ...
              >
                ...
                <p className="text-xs text-gray-600 dark:text-gray-400 leading-relaxed mb-2">{org.sublabel}</p>
                <p className="text-[10px] text-gray-400 dark:text-gray-500 italic">{org.connects}</p>
              </motion.div>
            );
          })}
        </div>
