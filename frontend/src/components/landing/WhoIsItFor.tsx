...
const orgTypes = [
  {
    ...
    label: 'Companies',
    sublabel: 'Business organizations',
    color: 'text-blue-600',
    bg: 'bg-blue-50',
  ...
  },
  {
    ...
    label: 'Laboratories',
    sublabel: 'Testing & research facilities',
  ...
  },
  {
    ...
    label: 'Universities',
    sublabel: 'Academic & research institutions',
  ...
  },
  {
    ...
    sublabel: 'Oversight & compliance authorities',
    color: 'text-red-600',
    bg: 'bg-red-50',
  ...
  },
  {
    ...
    label: 'Professionals',
    sublabel: 'Independent consultants & specialists',
      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        >
          ...
          <h2 className="text-4xl font-extrabold text-gray-900 tracking-tight mb-4">
            Built for Institutional Networks
          </h2>
          <p className="text-gray-500 text-lg leading-relaxed">
            MarcasNet supports collaboration between different types of organizations — whether you're a company, a lab, a university, or a regulatory body, the platform adapts to your structure.
          </p>
        </motion.div>
