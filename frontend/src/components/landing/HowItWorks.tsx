...
const steps = [
  ...
  },
  {
    ...
    description: 'Add your bio, role, and expertise to build a professional or institutional identity in the food ecosystem.',
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    description: 'Add lab reports, safety certificates, compliance records, and research documents to your credential library.',
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    description: 'Track products, batches, and certification workflows. Coordinate with labs and regulators from a single workspace.',
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
