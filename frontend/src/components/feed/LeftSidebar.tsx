...
function orgNav(orgId: string) {
  return [
      ...
      items: [
        {
          ...
          label: 'Products',
          matchPrefix: `/orgs/${orgId}/catalog`,
          icon: (
            <svg className="w-[18px] h-[18px]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {
          to: `/orgs/${orgId}/sourcing`,
          label: 'Sourcing',
          matchPrefix: `/orgs/${orgId}/sourcing`,
          icon: (
            <svg className="w-[18px] h-[18px]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      items: [
        {
          to: `/orgs/${orgId}/documents`,
          label: 'Documents',
          matchPrefix: `/orgs/${orgId}/documents`,
          icon: (
            <svg className="w-[18px] h-[18px]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
